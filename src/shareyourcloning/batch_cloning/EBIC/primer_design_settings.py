amanda_settings = {
    ...
    # nM primer concentration < Needs input
    ...
    'PRIMER_GC_CLAMP': 2,  # Number of GC bases required at the 3’ end
    ...
    'PRIMER_MAX_SELF_ANY': 40,  # < Needs input
    'PRIMER_MAX_SELF_END': 40,  # < Needs input
    'PRIMER_MAX_HAIRPIN': 40,  # < Needs input
