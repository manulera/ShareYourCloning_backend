...
for shift_1 in [0]:
    ...
    for shift_2 in [5]:
        ...
        subfragment_representation = assembly.edge_representation2subfragment_representation(assembly_plan, True)
        subfragments = assembly.get_assembly_subfragments([f1_shifted, f2_shifted], subfragment_representation)
        for s in subfragments:
            print('>', s.seq)
            for f in s.features:
                print(f)
            print()